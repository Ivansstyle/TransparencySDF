...
{
	if(m_transform == "")
        return "sdSphere(_position, " + m_size->text().toStdString() + ", vec4(clamp(" + m_color.m_x + ", 0.0, 1.0), clamp(" + m_color.m_y + ", 0.0, 1.0), clamp(" + m_color.m_z + ", 0.0, 1.0),(clamp(" + m_color.m_w + ", 0.0, 1.0)))";
	else
        return "sdSphere(vec3(" + m_transform + " * vec4(_position, 1.0)).xyz, " + m_size->text().toStdString() + ", vec4(" + m_color.m_x + ", " + m_color.m_y + ", " + m_color.m_z + ", " + m_color.m_w + "))";
}
