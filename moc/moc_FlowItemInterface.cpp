...
#include "../nodeEditor/FlowItemInterface.hpp"
...
void FlowItemInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FlowItemInterface *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (FlowItemInterface::*)(QString , QVariant );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FlowItemInterface::outputDataChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FlowItemInterface::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_FlowItemInterface.data,
    qt_meta_data_FlowItemInterface,
    qt_static_metacall,
    nullptr,
    nullptr
} };
